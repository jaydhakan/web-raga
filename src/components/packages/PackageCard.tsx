      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="focus-ring inline-flex min-h-12 items-center justify-center rounded-full bg-raga-pine px-5 py-3 text-sm font-extrabold text-raga-ivory shadow-card transition duration-300 hover:-translate-y-0.5 hover:bg-raga-forest hover:shadow-glow"
          >
